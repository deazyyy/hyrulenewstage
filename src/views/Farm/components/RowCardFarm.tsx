            ...
            <div className="farmcardmain">
                ...
                <div className="farmrow">
                    ...
                    <div className="btnouter mb-3">
                        <button className="btn-main disabled" onClick={() => depositRef.current.openModal()}> Compound</button>
                        <button className="btn-main disabled" onClick={() => childRef.current.openModal()}> Harvest</button>
                    </div>
